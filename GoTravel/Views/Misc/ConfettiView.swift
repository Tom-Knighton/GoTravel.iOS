...
fileprivate struct SingleConfettiView: View {
    ...
    public init(color: Color? = nil) {
        var backupColour: Color = .black
        switch(Int.random(in: 0...5)) {
            case 0: backupColour = Color.red
            case 1: backupColour = Color.orange
            case 2: backupColour = Color.yellow
            case 3: backupColour = Color.green
            case 4: backupColour = Color.blue
            case 5: backupColour = Color.purple
            default: backupColour = .black
        }
        self._color = State(wrappedValue: color ?? backupColour)
    }
